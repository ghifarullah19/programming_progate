...
class Main {
  public static void main(String[] args) {
    ...
    //Memanggil method instance run yang menerima input dari variable drive
    car.run(drive);
    ...
    //Menerima input dengan int yang ditetapkan ke variable
    int fueling = scanner.nextInt();
    //Memanggil method instance fueling yang menerima input dari variable charge 
    car.charge(fueling);
  }
}